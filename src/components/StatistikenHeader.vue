...
export default defineComponent({
  ...
  setup() {
   ...
   //   const response = await http.get("/webcodes/");
     ...
     options.value=[{"webcode":"biel","vereinsname":"Biel"},{"webcode":"obergerlafingen","vereinsname":"Obergerlafingen"},{"webcode":"grenchen","vereinsname":"Grenchen"},,{"webcode":"test","vereinsname":"Test"}];
    };
    var onChange = () => {
